...
function App() {
  ...
  const handleGenerateStory = async (e) => {
    ...
    if (!childName || !readingLevel || !selectedTheme) {
    ...
    try {
      ...
      if (data.story) {
        ...
        // Generate image for premium and family tiers
        if (subscriptionTier === 'premium' || subscriptionTier === 'family') {
          ...
          try {
            ...
            const imageResponse = await fetch(imageApiUrl, {
              ...
              body: JSON.stringify({
                prompt: `${data.story.title}. Child-friendly, colorful illustration in ${selectedTheme} theme`,
                style: 'illustration',
                mood: 'cheerful',
    ...
    return (
      <StoryDisplay 
        ...
        onBack={() => {
          ...
          // Reset form
          setChildName('');
          setReadingLevel('developing-reader');
          setSelectedTheme('');
          setMoralLesson('');
          setFavoriteThings('');
        }}
