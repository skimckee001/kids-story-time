...
function App() {
  ...
  const handleGenerateStory = async (e) => {
    ...
    try {
      ...
      // Temporarily falling back to v1 while debugging v2
      const endpoint = useV2 ? 'generate-story' : 'generate-story';
      // const endpoint = useV2 ? 'generate-story-v2-simple' : 'generate-story';
